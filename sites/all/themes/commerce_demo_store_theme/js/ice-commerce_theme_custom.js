(function ($) {
	...
	$("#section-content .form-submit").each(function(i){
							    //alert('a');
  $(this).wrap("<span class='bf-fs'></span>");	
});
	});
		 
  // Handle user toolbar when user is admin and have admin toolbar enabled.
  Drupal.behaviors.ice_commerce_custom_toolbar = {
  ...
  // on normal devices.
  Drupal.behaviors.ice_commerce_custom_search_api_ranges = {
    attach:function (context, settings) {
  ...
  Drupal.behaviors.ice_commerce_custom_search = {
    attach: function(context, settings) {
      $('body').bind('responsivelayout', function(e, d) {
